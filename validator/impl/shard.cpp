...
//    block::gen::ShardAccounts shardAccounts;
//    block::gen::ShardAccounts::Record shardAccountsRecord;
...
//            } else {
//                std::cout << "found account in block:" << acc_blk.account_addr << "\n";
//
//                vm::AugmentedDictionary accounts_dict{vm::load_cell_slice_ref(info.accounts), 256, block::tlb::aug_ShardAccounts};
//                auto acc_csr = accounts_dict.lookup(acc_blk.account_addr);
...
//                    }
//                    td::Ref<vm::Cell> c;
//                    acc_info.cell_pack(c, acc_info_rec);
//                    acc_info.print_ref(std::cout, c);
//                } else {
//                    std::cout << "acc_csr is null\n";
//                }
//            }
//        }
//    } else {
...
//    std::ofstream outfile("/tmp/soootest.log", std::ofstream::out | std::ofstream::app | std::ofstream::ate | std::ofstream::binary | std::ios_base::app) ;
//    shardAccounts.cell_pack(shard_state_cell, info.accounts->);
//    shardAccounts.print_ref(outfile, info.accounts);
//    outfile.close();
